...
def run_1(inf_callback, render_callback):
...
def main():
    ...
    def render_overlay2(engine, output, src_size, inference_box):
...
#     run_1(run_inference, render_overlay)

 

    th1 = Thread(target=run, args=(run_inference, render_overlay))

    th2 = Thread(target=run_1, args=(run_inference, render_overlay2))
